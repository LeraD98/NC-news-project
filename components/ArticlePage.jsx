...
const handleDelete = (comment_id) => {
  ...
  fetch(`https://backend-project-e32q.onrender.com/api/comments/${comment_id}`, {
    method: "DELETE",
  })
    .then((res) => {
...
<form onSubmit={handleSubmit} className="mt-6 max-w-3xl mx-auto">
  <label className="block mb-2 text-pink-200 text-lg font-medium">Add a Comment:</label>
  <textarea
    value={newComment}
            ...
            <div
              ...
              <p className="text-gray-200">{comment.body}</p>
                  ...
                  <button
                   ...
                   {deletingCommentIds.includes(comment.comment_id) ? "Deleting..." : "Delete"}
      </button>
    )}
            </div>
          ))}
